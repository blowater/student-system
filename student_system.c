...
//      5.添加课程
void *tch_add_cos(course *t_course);                            //  添加一门新的课程
//      6.修改课程
void change_tch_course(course *t_fcourse);                      //  教师修改课程 
//      7.删除课程
void delete_tch_course(course *t_fcourse);                      //  教师删除课程 
//      8.个人信息管理
...
void menu1(student *fstudent,teacher *fteacher, course *t_fcourse)
{
    ...
    else if (choice == 2)
	{
        ...
        if (np != NULL)
        {
            ...
            {
                //  修改课程
                change_tch_course(t_fcourse);         //  教师修改课程 
            }
            else if (choice == 6)
            {
                //  删除课程
                delete_tch_course(t_fcourse);         //  教师删除课程 
            }
            else if (choice == 7)
            {
                //  个人信息管理
...
void studentmenu2(student *fstudent, course *t_fcourse)         //  学生查询课程耳机菜单
{
    printf("--------[查询课程]--------\n");
	printf("\t1.根据课程名查询\n");  
	printf("\t2.根据开课学院查询\n");
